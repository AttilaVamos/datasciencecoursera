...
## I leave the '(' and ')' (also invalid chars in variable name) to indetify 
...
## Later the read.wfw automaticaly replaces '(' and ')' to '.' when create variable (column) names
